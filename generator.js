...
var validActions = actions + controlActions;
var validActionsLowerCase = validActions.toLowerCase();
var activeDirective = "";
var activeAttributes = {};
var activeEnclosedXML;
var currentDirective;  // Used with error messages
var recursionLevel;

var showErrorMessages;
var maxErrorMessageCount;
var numberOfErrorMessages;
var traceMode;
var traceDirectives;
...
function executeDirectives(directives) {
    ...
    while (iNext < directives.length) {
        ...
        currentDirective = directive;     // Used in error messages.
        ...
        var range = validActionsLowerCase.indexOf(actionLowerCase);
...
function getIntAttribute(attrib, required) {
    var val = activeAttributes[attrib.toLowerCase()];
    if (val == undefined) val = "";
...
function getIntAttribute(attrib, defaultVal) {
    var val = activeAttributes[attrib.toLowerCase()];
