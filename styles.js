...
function defineTextStyle() {
    ...
    textStyles[name] = {
        ...
        align: getStringAttribute("align") == "Yes",
        underline: getStringAttribute("underline") == "Yes",
...
function defineCanvasStyle() {
    ...
    canvasStyles[name] = {
        ...
        borderWidth: getIntAttribute("borderwidth",2),
        borderColor: getColorAttribute("bordercolor","Black"),
        allowCamera: getStringAttribute("allowcamera", false) == "Yes",
        allowImport: getStringAttribute("allowimport", false) == "Yes",
        allowMaps: getStringAttribute("allowmaps", false)   == "Yes",
        allowFillOnly: getStringAttribute("allowfillonly", false) == "Yes",
        allowMarkup: getStringAttribute("allowmarkup", false) == "Yes"
    };
}
